...
class Line{
  ...
  static beginDrawingLine(state, layerID, x, y) {
    console.log("beginDrawingLine--------------" + x);
    console.log("beginDrawingLine--------------" + y);
  ...
  static updateDrawingLine(state, x, y) {
    console.log("updateDrawingLine--------------" + x);
    console.log("updateDrawingLine--------------" + y);
  ...
  static endDrawingLine(state, x, y) {
    console.log("endDrawingLine--------------" + x);
    console.log("endDrawingLine--------------" + y);
  ...
  static updateDraggingLine(state, x, y) {
    console.log("---------updateDraggingLine");
    ...
    // console.log(draggingSupport.get('startVertex1X') - draggingSupport.get('startVertex0X'));
    var widthLength = draggingSupport.get('startVertex1X') - draggingSupport.get('startVertex0X')
    
    let newVertex0X, newVertex0Y, newVertex1X, newVertex1Y;
    
    if(widthLength > 0){
      console.log("width");
      
      newVertex0X = draggingSupport.get('startVertex0X');
      newVertex0Y = draggingSupport.get('startVertex0Y') + diffY;
      newVertex1X = draggingSupport.get('startVertex1X');
      newVertex1Y = draggingSupport.get('startVertex1Y') + diffY;
      
    }
    else{
      newVertex0X = draggingSupport.get('startVertex0X') + diffX;
      newVertex0Y = draggingSupport.get('startVertex0Y');
      newVertex1X = draggingSupport.get('startVertex1X') + diffX;
      newVertex1Y = draggingSupport.get('startVertex1Y');
    ...
    // console.log("newVertex0X" + newVertex0X );
    // console.log("newVertex0Y" + newVertex0Y );
    // console.log("newVertex1X" + newVertex1X );
    // console.log("newVertex1Y" + newVertex1Y );
