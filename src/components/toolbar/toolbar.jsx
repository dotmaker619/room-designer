...
import { MdCached, MdUndo, MdDirectionsRun } from 'react-icons/md';
    ...
    let sorter = [
      ...
      },
      {
        index: 3, condition: allowProjectFileSupport, dom: <ToolbarButton
          active={false}
          tooltip={translator.t('shelving')}
          onClick={event => {
            appSetActions.selectToolbar(3);
          }}>
          <img src={Logo3} />
        </ToolbarButton>
      },
      ...
      },
      {
        index: 13, condition: true, dom: <ToolbarButton
          ...
          tooltip={translator.t('Initialization')}
